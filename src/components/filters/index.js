      ...
      <div className="filterSections">
        ...
        <section className="filter">
          ...
          <div className="options">
            {years.map((year, i) => (
              <div onClick={() => this.props.setYear(year)} key={`year${i}`}>
                <span
                  className={this.props.config.year === year ? "active" : ""}
                >
                  {year}
                </span>
              </div>
        ...
        <section className="filter">
          ...
          <div className="options">
            <div onClick={() => this.props.setLaunch("true")}>
              ...
              <span
                className={this.props.config.launch == "true" ? "active" : ""}
              >
                True{" "}
              </span>
            </div>
            <div onClick={() => this.props.setLaunch("false")}>
              {/* eslint-disable-next-line */}
              <span
                className={this.props.config.launch == "false" ? "active" : ""}
              >
                False
              </span>
            </div>
        ...
        <section className="filter">
          ...
          <div className="options">
            <div onClick={() => this.props.setLand("true")}>
              {/* eslint-disable-next-line */}
              <span
                className={this.props.config.land == "true" ? "active" : ""}
              >
                True{" "}
              </span>
            </div>
            <div onClick={() => this.props.setLand("false")}>
              {/*  eslint-disable-next-line */}
              <span
                className={this.props.config.land == "false" ? "active" : ""}
              >
                False
              </span>
            </div>
